...
\begin{itemize}
    \item  The Role of Loss Aversion in Multi-Rater Subjective Performance Evaluations (with Takahiro Morimitsu). Available at: \url{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5083726}.
    
    \item On The Use Of Calibration Committees In Subjective Performance Evaluation (with Takahiro Morimitsu).. Available at: \url{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4290250}.
    
    \item Conformity pressure and compensation contracts (with Yutaro Murakami).. Available at: \url{https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4113994}.
\end{itemize}
